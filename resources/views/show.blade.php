    ...
    <div class="buttons-container flex justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="hidden absolute z-10 w-104 text-left font-semibold bg-white rounded-xl shadow-dialog mt-2">
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 w-76 text-left font-semibold rounded-xl bg-white shadow-dialog mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
